...
contract StarNotary is ERC721 {
    ...
    string public constant name = "DucDA10Star";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(token1Owner == msg.sender || token2Owner == msg.sender, "No sender detected");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender , "No sender detected");
